...
//            throw new SmartRuntimeException(EnumSmartException.CAMPO_MENOR_IGUAL_ZERO, name);
//        }
//    }
//
...
//            throw new SmartRuntimeException(EnumSmartException.CAMPO_MENOR_QUE, name, min);
//        }
//    }
//
...
//        if (number != null && number.doubleValue() > min.doubleValue()) {
//            throw new SmartRuntimeException(EnumSmartException.CAMPO_MENOR_OU_IGUAL_QUE, name, min);
//        }
//    }
//
//    public static <N extends Number> void validateGreaterThan(N number, N min, String name) {
//        if (number != null && number.doubleValue() <= min.doubleValue()) {
//            throw new SmartRuntimeException(EnumSmartException.CAMPO_MAIOR_QUE, name, min);
//        }
//    }
//
//    public static <N extends Number> void validateGreaterThanOrEqual(N number, N min, String name) {
//        if (number != null && number.doubleValue() < min.doubleValue()) {
//            throw new SmartRuntimeException(EnumSmartException.CAMPO_MAIOR_OU_IGUAL_QUE, name, min);
//        }
//    }
//
...
//                throw new SmartRuntimeException(EnumSmartException.CAMPO_ENTRE, name, min, max);
//            }
//        }
//    }
//
...
//            throw new SmartRuntimeException(EnumSmartException.CAMPO_MINIMO_CARACTERS, name, min);
//        }
//    }
//
//    public static <N extends Number> void validateMaxCaracter(String value, int max, String name) {
//        if (value != null && value.trim().length() > max) {
//            throw new SmartRuntimeException(EnumSmartException.CAMPO_MAXIMO_CARACTERS, name, max);
//        }
//    }
//
...
//            throw new SmartRuntimeException(EnumSmartException.HORA_INICIAL_MAIOR_DATA_FINAL, format.format(dataInicial), format.format(dataFinal));
//        }
//    }
//
//    public static void validateDateGreaterThen(Date dataInicial, Date dataFinal, EnumDateFormat format) {
//        if (DateUtil.compareTo(dataInicial, dataFinal, format) > 0) {
//            throw new SmartRuntimeException(EnumSmartException.DATA_INICIAL_MAIOR_DATA_FINAL, format.format(dataInicial), format.format(dataFinal));
//        }
//    }
//
...
//            throw new SmartRuntimeException(EnumSmartException.DATA_MAIOR_DATA_ATUAL, name, EnumDateFormat.DDMMYYYY.format(dataTest));
//        }
//    }
//
...
//            throw new SmartRuntimeException(EnumSmartException.DATA_MENOR_DATA_ATUAL, name, EnumDateFormat.DDMMYYYY.format(dataTest));
//        }
//    }
//
...
//            throw new SmartRuntimeException(EnumSmartException.CAMPO_IGUAL_CARACTERS, name, size);
//        }
//    }
//
...
//            if (value.length() > 0) {
//                throw new SmartRuntimeException(EnumSmartException.CAMPO_SOMENTE_NUMEROS, name);
//            }
//        }
//    }
//
