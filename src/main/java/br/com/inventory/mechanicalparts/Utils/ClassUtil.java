...
public class ClassUtil {
    ...
    public static Method getSetterMethod(String fieldName, Class<?> clazz){
        return Stream.of(clazz.getDeclaredMethods())
                .filter(method -> ClassUtil.isSetterMethod(method, fieldName))
                .findFirst()
                .orElse(null);
    }
                ...
                if (isType(clzz, BigDecimal.class)) {
                    ...
                    if (valor.getClass().equals(clzz)) {
                        ...
                        if (isType(clzz, Date.class)) {
                            ...
                            String[] split = Util.nvl(valString, "").split(regex);
                            ...
                            return (T) "Testet"; //StringUtils.splitPreserveAllTokens(valString, token);
                        ...
                        if (Number.class.isAssignableFrom(clzz)) {
                            ...
                            if (Util.isEmpty(valString) || !NumericUtil.isNumeric(valString)) {
                                return null;
                            }
                        }
