...
//import com.smartbr.clinica.model.entity.FichaAnamnese;
...
//
//        if (entity == null) {
//            throw new SmartRuntimeException(EnumSmartException.ENTITY_NOT_FOUND, getEntityName(), id);
//        }
//        return entity;
//    }
//
...
//    }
//
//    protected Query createQuery(CriteriaQuery<FichaAnamnese> criteriaQuery) {
...
//    }
//
//    protected Query createNativeQueryWithOutClassType(String query) {
